...
class MakeReactComponent extends Command
{
    ...
    public function handle()
    {
        ...
        $componentsPath = resource_path("js/components/{$componentName}.jsx");
        $uiPath = resource_path("js/components/ui/{$componentName}.jsx");
        $pagesPath = resource_path("js/pages/{$componentName}.jsx");
